        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12">
            <div class="about-content">
              ...
              <h3>Anak anda pengidap
              <?php foreach($data as $u){ ?>
               <?php if($u->Class = "yes")
               {
                  $pengidap = "Pengidap Autis";
                  $hasil = "Segera Konsultasikan dengan dokter atau atau ahli kesehatan profesional terdekat dan utarakan segala kondisinya";
               }
               else{
                  $pengidap = "Tidak Pengidap Autis";
                  $hasil = "Selamat anda tidaak mengidap autis, maka jaga baik kesehatan anda";
               } ?>

              <?php echo $pengidap; ?> <?php } ?></h3>
              <p><?php echo $hasil; ?>. </p>
